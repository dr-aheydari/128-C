...
ydots(1) = y(2);
ydots(2) = -0.01 * y(2) - 0.4 * (a1 + a2 - 2) / a + 0.2 ...
    * W * sin(omega * t);
ydots(3) = y(4);
...
% for w = 55 
%  Magnifying factor = 4.307561e+01
%  for w = 56 
%  Magnifying factor = 5.122299e+01
%  for w = 57 
%  Magnifying factor = 6.155147e+01
%  for w = 58 
%  Magnifying factor = 7.575393e+01
%  for w = 59 
%  Magnifying factor = 1.004610e+02
%  for w = 60 
%  Magnifying factor = 2.095814e+02
%  for w = 61 
%  Magnifying factor = 2.185854e+02
%  for w = 62 
%  Magnifying factor = 2.272185e+02
%  for w = 63 
%  Magnifying factor = 2.327945e+02
%  for w = 64 
%  Magnifying factor = 2.399577e+02
%  for w = 65 
%  Magnifying factor = 2.455027e+02
